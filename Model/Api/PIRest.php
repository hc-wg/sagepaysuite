...
class PIRest
{
    ...
    protected function _getServiceUrl($enpoint)
    {
        ...
        if ($this->_config->getPIMode() == \Ebizmarts\SagePaySuite\Model\Config::MODE_LIVE) {
            $api_url = \Ebizmarts\SagePaySuite\Model\Config::URL_PI_API_LIVE;
        } else {
            $api_url = \Ebizmarts\SagePaySuite\Model\Config::URL_PI_API_TEST;
        }

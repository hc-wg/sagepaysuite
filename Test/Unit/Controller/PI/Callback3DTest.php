...
class Callback3DTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecuteSUCCESS()
    {
        ...
        $cryptAndCodeMock
            ...
            ->withConsecutive([self::ENCODED_ORDER_ID], [self::ENCODED_QUOTE_ID])
            ->willReturnOnConsecutiveCalls(self::ORDER_ID, self::QUOTE_ID);
    ...
    public function testExecuteOrderStateNotPendingPayment()
    {
        ...
        $this->requestMock
            ->expects($this->exactly(2))
            ->method('getParam')
            ->withConsecutive(['orderId'], ['quoteId'])
    ...
    private function makeRequestMock($pares, $postRequest)
    {
        ...
        $this->requestMock
            ...
            ->method('getParam')
            ->withConsecutive(['orderId'], ['quoteId'], ['transactionId'], ['saveToken'])
            ->willReturnOnConsecutiveCalls(
                self::ENCODED_ORDER_ID,
                self::ENCODED_QUOTE_ID,

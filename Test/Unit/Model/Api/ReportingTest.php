...
class ReportingTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetTransactionDetailsByVendorTxCode()
    {
        ...
        $responseMock
            ...
            ->willReturn($this->getTransactionDetailsByVendorTxCodeResponse());
        ...
        $httpTextMock
            ->expects($this->once())
            ->method('setUrl')
            ->with(Config::URL_REPORTING_API_TEST);
        $httpTextMock
            ->expects($this->once())
            ->method('executePost')
            ->with($this->getTransactionDetailsByVendorTxCodeRequestXML())
            ->willReturn($responseMock);

        $simpleInstance = new \SimpleXMLElement($this->getTransactionDetailsByVendorTxCodeResponseXml());
        $this->objectManagerMock->method('create')->willReturn($simpleInstance);

        $httpTextFactory = $this
    ...
    private function getTransactionDetailsByVendorTxCodeResponse()
    {
